...
L['AuctionFaster - Historical Options'] = 'EUI拍賣助手 - 歷史選項'
L['Enable Historical Data Collection'] = '啟用歷史紀錄'
L['Days to keep data (5-50)'] = '紀錄的天數，5至50天'
L['AuctionFaster - Pricing Options'] = 'EUI拍賣助手 - 價格選項'
L['Historical Options'] = '歷史選項'
L['Pricing Options'] = '價格選項'
L['Maximum difference bid to buy (1-100%)'] = '最大差價買入（1-100%）';
L['AuctionFaster Options'] = 'EUI拍賣助手 - 選項'
L['AuctionFaster'] = 'EUI拍賣助手';
L['Enable AuctionFaster'] = '啟用EUI拍賣助手'
L['Fast Mode'] = '快速模式'
...
L['No auction found with minimum quantity: '] = '未找到符合最小堆疊數量為%d的拍賣品'
...
L['Enter query and hit search button first'] = '先輸入要搜索的物品關鍵字，然後點擊搜索按鈕'
L['No auction found for minimum stacks: '] = '該物品找不到符合過濾條件為最小堆疊%d的專案。'
L['Addon Tutorial'] = '新手教程'
L['Addon settings'] = '設置選項'
...
L['This button opens up filters.\nClick again to close.'] = '點擊這裏打開過濾選項。\n再次點擊關閉。'
...
L['and progress bar will show\nthe amount of auctions.'] = '這裏的“拍賣”進度條則顯示待購條目的數量。'
...
L[' in the box on the right'] = '數量就是你在右邊輸入框設置的值'
L['Finds the first auction '] = '尋找拍賣中'
L['across all the pages'] = '該物品所有'
L[' that meets the minimum quantity\n\n'] = '符合“最小堆疊數量”的條目。\n'
L['You need to enter a search query first'] = '你必需先輸入要搜索的東西才能進一步按數量過濾。'
L['Opens this tutorial again.\nHope you liked it\n\n:)\n\n'] = '點擊這裏可以重新打開新手教程。\n希望你喜歡它。\n\n:)\n\n'

-- buy UI
L['Buy Items'] = '買入'
L['AuctionFaster - Buy'] = 'EUI拍賣助手 - 購買'
L['Search'] = '搜索'
...
L['Bid / Item'] = '每單位競標價'
L['Buy / Item'] = '每單位直購價'
L['Chose your search criteria nad press "Search"'] = '選擇搜索條件後按“搜索”'

-- sell functions
L['Qty: %d, Max Stacks: %d, Remaining: %d'] = '數量：%d，堆疊可售%d組，剩餘%d個'
L['Last scan: %s'] = '上次掃瞄：%s'
L['Stack Size (Max: %d)'] = '堆疊（最大%d）'
L['Please refresh auctions first'] = '請先按刷新，重整拍賣'
L['Yes'] = '是'
L['No'] = '否'
...
L['No historical data available for: '] = '沒有關於%s的歷史紀錄可查閱。'
L['Lowest Buy'] = '最低購買價'
L['Trend Lowest Buy'] = '趨勢最低買入';
L['Average Buy'] = '平均購買價';
L['Trend Average Buy'] = '趨勢平均買入';
L['Highest Buy'] = '最高購買價'
L['Test Line'] = '測試線';
L['Historical Data: '] = '歷史紀錄：'
...
L['Remember Stack Settings'] = '記住堆疊設置'
...
L['If there is no auctions of this item,'] = '如果要上架時，拍賣場裏沒有你先前上架的物品作為出價參考，'
...
L['if "Always Undercut" options is checked!'] = '你記住的價格會被複蓋。' -- switch translate for previous entry to keep chinese word order correct.
L['Checking this option will make\nAuctionFaster remember how much\n' ..
	'stacks you wish to sell at once\nand how big is stack'] = '啟用這個選項會使\nEUI拍賣助手記住你每次要上架的每組堆疊與組數'
L['By default, AuctionFaster always undercuts price,\neven if you toggle "Remember Last Price"\n'..
	'If you uncheck this option AuctionFaster\nwill never undercut items for you'] = 'EUI拍賣助手會自動壓價，使上架的價格永遠是最低價，就算你勾選了“記住上次價格”也一樣。\n如果你取消這項，Auction Faster就不再替你自動壓價。'

-- sell tutorial
L['Welcome to AuctionFaster.\n\nI recommend checking out sell tutorial at least once before you accidentally sell your precious goods.\n\n:)'] = '歡迎使用Auction Faster。\n\n誠摯地建議您，為了避免誤賣貴重物品，使用前先閱讀一遍新手教程。'
L['Here is the list of all inventory items you can sell, no need to drag anything.\n\n'] = '這是你行囊中可出售物品的清單，不需要拖曳任何東西，它們會自動顯示在這裏。\n\n'
L['After you select item, AuctionFaster will automatically make a scan of first page and undercut set bid/buy according to price model selected.'] = '當你選擇一樣物品，EUI拍賣助手會自動掃瞄該物品的拍賣列表，然後根據壓價模式計算出售價。'
L['Here you will see selected item. Max stacks means how much of stacks can you sell according to your setting. Remaining means how much quantity will still stay in bag after selling item.'] = '你會在這裏看見剛才選擇的物品。“堆疊可售”的數量指的是按你設置的堆疊可以出售幾疊。“剩餘”的數量指的是扣除那些預計要出售的數量後，包裏還剩下多少個。'
L['AuctionFaster keeps auctions cache for about 10 minutes, you can see when last real scan was performed.\n\n'] = 'EUI拍賣助手會自動保留拍賣搜索結果緩存大約十分鐘，你可以看到上次執行即時掃瞄的時間。'
L['You can click Refresh Auctions to scan again'] = '你可以點擊“刷新拍賣”來重新掃瞄。'
...
L['AuctionFaster understands a lot of money formats'] = 'EUI拍賣助手可以辨識多種貨幣格式'
L[', for example:\n\n' .. '5g 6s 19c\n5g6s86c\n999s 50c\n3000s\n9000000c'] = '，例如：\n\n' .. '5g 6s 19c\n5g6s86c\n999s 50c\n3000s\n9000000c'
...
L['Those settings are per specific item'] = '這是針對指定物品的額外上架設置'
...
L['You can be sure your item will be cheapest.\n'] = '你可以對照價格，確定物品將會以最低價出售。\n'
L['These are always sorted by lowest price per item.'] = '這個列表總是按物品單價由低至高排列。'
L['This button allows you to buy selected item. Useful for restocking.'] = '點擊這個按鈕可以購買選定的專案，使掃貨更方便。'
L['Posts %s of selected item regardless of your\n"# Stacks" settings'] = '只上架%s物品，而不管你對“出售幾組”的設置。'
L['Posts %s of selected item according to your\n"# Stacks" settings'] = '根據你對“出售幾組”的設置，將%s物品上架。'
L['one auction'] = '一項'
L['all auctions'] = '全部'
L['Once you close this tutorial it won\'t show again unless you click it'] = '關閉教程就不再顯示，除非你再次點擊這個按鈕。'

-- sell ui
L['Sell Items'] = '賣出'
L['AuctionFaster - Sell'] = 'EUI拍賣助手 - 出售'
L['Refresh inventory'] = '刷新庫存'
L['Sort settings'] = '排序設置'
L['Sort by'] = '分類'
L['Name'] = '名字'
L['Price'] = '價格'
L['Quality'] = '品質'
...
L['Refresh Auctions'] = '刷新拍賣'
L['Post All'] = '上架全部'
L['Post One'] = '上架一個'
L['Lvl'] = '等級'	-- qty and stack and lvl in list are invisible in asia client after translate because not enough space for them.