...
L['AuctionFaster - Historical Options'] = 'EUI拍卖助手 - 历史选项'
L['Enable Historical Data Collection'] = '启用历史纪录'
L['Days to keep data (5-50)'] = '纪录的天数，5至50天'
L['AuctionFaster - Pricing Options'] = 'EUI拍卖助手 - 价格选项'
L['Historical Options'] = '历史选项'
L['Pricing Options'] = '价格选项'
L['Maximum difference bid to buy (1-100%)'] = '最大差价买入（1-100%）';
L['AuctionFaster Options'] = 'EUI拍卖助手 - 选项'
L['AuctionFaster'] = 'EUI拍卖助手';
L['Enable AuctionFaster'] = '启用EUI拍卖助手'
L['Fast Mode'] = '快速模式'
...
-- buy UI
L['Buy Items'] = '买入'
L['AuctionFaster - Buy'] = 'EUI拍卖助手 - 购买'
L['Search'] = '搜索'
...
L['Lowest Buy'] = '最低购买价'
L['Trend Lowest Buy'] = '趋势最低买入';
L['Average Buy'] = '平均购买价';
L['Trend Average Buy'] = '趋势平均买入';
L['Highest Buy'] = '最高购买价'
L['Test Line'] = '测试线';
L['Historical Data: '] = '历史纪录：'
...
L['After you select item, AuctionFaster will automatically make a scan of first page and undercut set bid/buy according to price model selected.'] = '当你选择一样物品，EUI拍卖助手会自动扫瞄该物品的拍卖列表，然后根据压价模式计算出售价。'
...
L['AuctionFaster understands a lot of money formats'] = 'EUI拍卖助手可以辨识多种货币格式'
L[', for example:\n\n' .. '5g 6s 19c\n5g6s86c\n999s 50c\n3000s\n9000000c'] = '，例如：\n\n' .. '5g 6s 19c\n5g6s86c\n999s 50c\n3000s\n9000000c'
...
-- sell ui
L['Sell Items'] = '卖出'
L['AuctionFaster - Sell'] = 'EUI拍卖助手 - 出售'
