...
local function CreateCheckButtonText(btn, text)
	btn.text = btn.text or btn:CreateFontString("OVERLAY")
	btn.text:FontTemplate()
	btn.text:Point("CENTER", btn, "CENTER")
...
--	SlashCmdList["ExAE"] = ExAE_Command;
	...
	-- ExAE_Frame:SetTemplate()	
	E.Skins:HandleCheckBox(ExAE_FrameSetButton1, true, nil, true)
	E.Skins:HandleCheckBox(ExAE_FrameSetButton2, true, nil, true)
	E.Skins:HandleCheckBox(ExAE_FrameSetButton3, true, nil, true)
	E.Skins:HandleCheckBox(ExAE_FrameSetButton4, true, nil, true)
	E.Skins:HandleCheckBox(ExAE_FrameNakedButton, true, nil, true)
	E.Skins:HandleButton(ExAE_FrameSaveButton, true)
	
	CreateCheckButtonText(ExAE_FrameSetButton1, '1')
	CreateCheckButtonText(ExAE_FrameSetButton2, '2')
	CreateCheckButtonText(ExAE_FrameSetButton3, '3')
	CreateCheckButtonText(ExAE_FrameSetButton4, '4')
	CreateCheckButtonText(ExAE_FrameNakedButton, 'N')
	CreateCheckButtonText(ExAE_FrameSaveButton, 'S')

	E:CreateMover(ExAE_Frame, 'ExAE_FrameMover', L['Ex_AutoEquip'], nil, nil, nil, 'ALL,EUI', nil, 'singleFunc,ui,Ex_AutoEquip')
end 
