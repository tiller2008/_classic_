...
if not AS:CheckAddOn('AuctionLite-classic') then return end
...
function AS:AuctionLite(event)
	...
	AS:UnregisterSkinEvent('AuctionLite-classic', event)
end

AS:RegisterSkin('AuctionLite-classic', AS.AuctionLite, 'AUCTION_HOUSE_SHOW')
