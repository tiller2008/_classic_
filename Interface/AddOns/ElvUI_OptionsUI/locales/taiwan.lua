...
do
	...
	L["This release of ElvUI contains changes to how we handle UI scale. See changelog for specifics. We need to set your UI scale again in order to use a new system. It appears your old UI scale was %s.\n\nYou can either apply this value, or use the 'Auto Scale' function to apply the UI scale that is considered the most optimal for your resolution.\n\nYou also have the option of choosing your own UI scale in the General section of the ElvUI config. In theory ElvUI should be able to look pixel perfect with any UI scale now but there may be a few issues with the ingame config."] = "EUI採用了新的UI縮放方式,你的舊用戶介面縮放比例似乎是 %s.\n\n 您可以應用此值，或使用自動縮放功能應用被認為更適合你解析度的UI比例.\n\n系統的UI縮放設置介面被隱藏,你可在EUI設置介面的一般設置中進行調整."
	L["The UI Scale has been changed, if you would like to preview the change press the preview button. It is recommended that you reload your User Interface for the best appearance."] = "用戶介面縮放比例已改變，如要預覽更改，請按預覽按鈕。建議重新加載用戶介面以獲得最佳效果."
...
L["You can always change fonts and colors of any element of ElvUI from the in-game configuration."] = "你可以在遊戲內的設定選項內更改EUI的字體、顏色等設定."
L["This will change the layout of your unitframes and actionbars."] = "這將改變動作條和單位框體的佈局"
...
do
	...
	L['MerInspect'] = "裝等觀察顯示"
	L['Show Config'] = "顯示設置"
	L["Use Eui's number format"] = "使用EUI數字縮寫";
	L['singleFunc'] = '單體插件管理';
	L['singleFunc_desc'] = '集中管理、自動更新、按需加載、設置方便';
	L['HandyNotes_DungeonLocations'] = '地下城位置模組'
	L['HandyNotes_FlightMasters'] = '飛行點位置模組';
	L["HandyNotes_NPCs"] = "NPC位置模組"
	L['MikScrollingBattleText'] = 'MSBT戰鬥文字';
	L['Show MikScrollingBattleText Config'] = '顯示MSBT設置';
	L['Disable Blz CombatText'] = '禁用暴雪浮動戰鬥資訊';
	L['DBM-Core'] = 'DBM報警模組';
	...
	L['Recount'] = 'Recount戰鬥統計';
	L['Show Recount Window'] = '顯示Recount窗口';
	L['Reset Recount Profile'] = '重置Recount配置';
...
do
	...
	L["QuestTimerFrame"] = "任務計時框"
	L['objectiveTrackerFrame'] = "任務追蹤框"
	L['autoTrackQuest'] = "自動追蹤任務"
...
L["Player Can Attack"] = "玩家能攻擊"
L["Player Can Not Attack"] = "玩家不能攻擊"
L["Reset Nameplate CVars to the ElvUI recommended defaults."] = "重置姓名板 CVars 到 EUI 預設的推薦值."
