...
do
	...
	L["This release of ElvUI contains changes to how we handle UI scale. See changelog for specifics. We need to set your UI scale again in order to use a new system. It appears your old UI scale was %s.\n\nYou can either apply this value, or use the 'Auto Scale' function to apply the UI scale that is considered the most optimal for your resolution.\n\nYou also have the option of choosing your own UI scale in the General section of the ElvUI config. In theory ElvUI should be able to look pixel perfect with any UI scale now but there may be a few issues with the ingame config."] = "EUI采用了新的UI缩放方式,你的旧用户界面缩放比例似乎是 %s.\n\n 您可以应用此值，或使用自动缩放功能应用被认为更适合你分辨率的UI比例.\n\n系统的UI缩放设置界面被隐藏,你可在EUI设置界面的一般设置中进行调整."
	L["The UI Scale has been changed, if you would like to preview the change press the preview button. It is recommended that you reload your User Interface for the best appearance."] = "用户界面缩放比例已改变，如要预览更改，请按预览按钮。建议重新加载用户界面以获得最佳效果."
...
L["This will change the layout of your unitframes and actionbars."] = "这将改变动作条和单位框体的布局"
L["You can always change fonts and colors of any element of ElvUI from the in-game configuration."] = "你可以在游戏内的设定选项内更改EUI的字体、颜色等设定."
L["Waiting.."] = "等待中..."
...
do
	...
	L['HandyNotes_DungeonLocations'] = '地下城位置模块'
	L['HandyNotes_FlightMasters'] = '飞行点位置模块';
	L["HandyNotes_NPCs"] = "NPC位置模块"
	...
	L['Recount'] = 'Recount战斗统计';
	L['Show Recount Window'] = '显示Recount窗口';
...
do
	...
	L['WeaponSwingTimer'] = "平砍计时条"
	L["QuestTimerFrame"] = "任务计时框"
	L['objectiveTrackerFrame'] = "任务追踪框"
	L['autoTrackQuest'] = "自动追踪任务"
...
L["Player Can Attack"] = "玩家能攻击"
L["Player Can Not Attack"] = "玩家不能攻击"
L["Reset Nameplate CVars to the ElvUI recommended defaults."] = "重置姓名版CVars到EUI推荐默认值"
