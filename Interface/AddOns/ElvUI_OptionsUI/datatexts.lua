					...
					args = {
						...
						width = {
							...
							set = function(info, value)
								...
								Layout:ChangeSize(TopDataTextsBar1);
								Layout:ChangeSize(TopDataTextsBar2);
								Layout:ChangeSize(TopDataTextsBar3, 3);
								Layout:ChangeSize(TopDataTextsBar4, 2);
								Layout:ChangePositon()
