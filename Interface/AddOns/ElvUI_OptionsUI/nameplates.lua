				...
				general = {
					...
					args = {
						...
						loadDistance = {
							...
							get = function() return E.db.nameplates.loadDistance end,
							disabled = true,
							set = function(info, value)
		...
		targetGroup = {
			...
			args = {
				...
				topArrowType = {
					...
					disabled = function()
						if E.db.nameplates.units.TARGET.glowStyle == 'style3' or E.db.nameplates.units.TARGET.glowStyle == 'style5' or E.db.nameplates.units.TARGET.glowStyle == 'style6' then
							return false
						else
							return true
						end
				...
				leftArrowType = {
					...
					disabled = function()
						if E.db.nameplates.units.TARGET.glowStyle == 'style4' or E.db.nameplates.units.TARGET.glowStyle == 'style7' or E.db.nameplates.units.TARGET.glowStyle == 'style8' then
							return false
						else
							return true
						end
				...
				ArrowSpace = {
					...
					name = L["Spacing"],
					disabled = function()
						if E.db.nameplates.units.TARGET.glowStyle == 'style1' or E.db.nameplates.units.TARGET.glowStyle == 'style2' then
							return true
						else
							return false
						end
