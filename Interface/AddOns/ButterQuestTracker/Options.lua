...
LibStub("AceConfig-3.0"):RegisterOptionsTable("ButterQuestTracker", function()
    return {
        ...
        args = {
            ...
            visuals = {
                name = BQTL:GetStringWrap("SETTINGS_VISUAL_TAB"),
                type = "group",
                order = order(),
                ...
                args = {
                    ...
                    trackerHeaderSettings = {
                        name = BQTL:GetStringWrap("SETTINGS_TRACKER_HEADER_NAME"),
                        type = "group",
                        inline = true,
                        order = order(),
                    ...
                    zoneHeaderSettings = {
                        name = BQTL:GetStringWrap("SETTINGS_ZONE_HEADER_NAME"),
                        type = "group",
                        inline = true,
                        order = order(),
                    ...
                    questHeaderSettings = {
                        name = BQTL:GetStringWrap("SETTINGS_COLOR_HEADERS_NAME"),
                        type = "group",
                        inline = true,
                        order = order(),
                    ...
                    objectiveSettings = {
                        name = BQTL:GetStringWrap("SETTINGS_OBJECTIVE_SETTINGS_NAME"),
                        type = "group",
                        inline = true,
                        order = order(),
