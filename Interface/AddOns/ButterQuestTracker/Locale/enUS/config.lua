ButterQuestTrackerLocale.locale['enUS'] = {
	...
	['SETTINGS_TRACKER_HEADER_NAME'] = 'Tracker Header Settings',
	...
	['SETTINGS_ZONE_HEADER_NAME'] = 'Zone Header Settings',
	...
	['SETTINGS_COLOR_HEADERS_NAME'] = "Quest Header Settings",
	...
	['SETTINGS_OBJECTIVE_SETTINGS_NAME'] = "Objective Settings",
