...
Addon:SetScript("OnEvent", function(self, event, arg1,...) return self[event](self, arg1,...) end)
...
function Addon:ADDON_LOADED(arg1)
 if arg1 ~= 'HandyNotes_NPCs (Classic)' then return end
 local options = {
 type = "group",
 name = "NPCs",
 ...
 if db.mapButton then
	...
	self:UnregisterEvent("ADDON_LOADED") -- Probably Not Needed
