...
-- This is in the format of [NPC who made the yell] = { ["Yell"]="encouter",[yell]="encounter"}
-- ================================
L.BOSS_YELL_LIST = {
    --["Valithria Dreamwalker"] = {
    --    ["I AM RENEWED! Ysera grant me the favor to lay these foul creatures to rest!"] = "Valithria Dreamwalker" },
}

L.BOSS_MAP = {
    ["Molten Core"] = "BossDKPMCAndOLValue",
    ["Onyxia's Lair"] = "BossDKPMCAndOLValue",
    ["Blackwing Lair"] = "BossDKPBWLValue",
    ["Ahn'Qiraj"] = "BossDKPTAQValue",
    ["Naxxramas"] = "BossDKPNAXXValue"
}
