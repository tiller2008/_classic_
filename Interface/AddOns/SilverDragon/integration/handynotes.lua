...
function module:OnInitialize()
	...
	local options = {
		...
		args = {
			icon = {
				type = "group",
				name = GetLocaleText("Icon settings"),
				inline = true,
				args = {
					desc = {
					...
					icon_scale = {
						type = "range",
						name = GetLocaleText("Icon Scale"),
						desc = GetLocaleText("The scale of the icons"),
					...
					icon_alpha = {
						type = "range",
						name = GetLocaleText("Icon Alpha"),
						desc = GetLocaleText("The alpha transparency of the icons"),
			...
			display = {
				type = "group",
				name = GetLocaleText("What to display"),
				inline = true,
				args = {
					-- achieved = {
					-- 	type = "toggle",
					...
					unhide = {
						type = "execute",
						name = GetLocaleText("Reset hidden mobs"),
						desc = GetLocaleText("Show all nodes that you manually hid by right-clicking on them and choosing \"hide\"."),
						func = function()
							wipe(db.hidden)
							module:SendMessage("HandyNotes_NotifyUpdate", "SilverDragon")
						end,
