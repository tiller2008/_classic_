...
function E:CreateMoverPopup()
	...
	hideDisableFrame:SetScript("OnShow", function(cb)
		cb:SetChecked(E.db.general.hideDisableFrame)
	end)

	hideDisableFrame:SetScript("OnClick", function(cb)
		E.db.general.hideDisableFrame = cb:GetChecked()
	...
	nudge:SetScript("OnShow", function(cb)
		cb:SetChecked(E.db.general.nudgeWindow)
	end)

	nudge:SetScript("OnClick", function(cb)
		E.db.general.nudgeWindow = cb:GetChecked() or false
