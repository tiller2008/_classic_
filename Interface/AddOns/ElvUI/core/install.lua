...
function E:SetupActionbar(value)
	...
	if _G.InstallStepComplete then
		_G.InstallStepComplete.message = L["Eui AB Style"]
...
function E:SetupUFStyle(value)
	...
	if _G.InstallStepComplete then
		_G.InstallStepComplete.message = L["Eui UF Style"]
		_G.InstallStepComplete:Show()	
	end
end
...
function E:SetupLayout(layout, noDataReset, noDisplayMsg)
	...
	--	E.db.movers.ElvUF_Raid40Mover = "TOPLEFT,ElvUIParent,BOTTOMLEFT,4,482"
		...
		E.db.unitframe.units.party.rdebuffs.font = "EUI"
		...
		E.db.unitframe.units.raid.rdebuffs.font = "EUI"
	...
	--	E.db.unitframe.units.raid40.rdebuffs.font = "EUI"
...
local function ResetAll()
	...
	_G.InstallTutorialImage:Size(250)
	_G.InstallTutorialImage:SetTexture(nil)
	_G.InstallTutorialImage:Hide()	
end

local function BorderSetup(toggle)
	E.private.general.pixelPerfect = toggle;

	_G.InstallStepComplete.message = toggle and L["Thin Border Theme"] or L["Normal Border Theme"]
	_G.InstallStepComplete:Show()
...
local function SetPage(PageNum)
	...
	elseif PageNum == 7 then
		f.SubTitle:SetText(L["Thin Border Theme"])
		f.Desc1:SetText(L["The Thin Border Theme option will change the overall apperance of your UI. Using Thin Border Theme is a slight performance increase over the traditional layout."])

		InstallOption1Button:Show()
		InstallOption1Button:SetScript("OnClick", function() BorderSetup(true) end)
		InstallOption1Button:SetText(L["Thin Border Theme"])
		InstallOption2Button:Show()
		InstallOption2Button:SetScript('OnClick', function() BorderSetup(false) end)
		InstallOption2Button:SetText(L["Normal Border Theme"])
	...
	elseif PageNum == 11 then
		...
		InstallOption1Button:Show()
		InstallOption1Button:SetScript("OnClick", function() E:StaticPopup_Show("RESET_PROFILE_PROMPT") end)
		InstallOption1Button:SetText(RESET.. L["Profile"])
		InstallOption2Button:Show()
