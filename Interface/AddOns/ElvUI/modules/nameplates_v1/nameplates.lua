...
local mod = E:NewModule('NamePlates_v1', 'AceHook-3.0', 'AceEvent-3.0', 'AceTimer-3.0')
...
function mod:ConfigureAll()
	if E.private.nameplates_v1.enable ~= true then return; end
...
function mod:CVarReset()
	SetCVar("nameplateMinAlpha", "0.1")
	...
	SetCVar("nameplateShowAll", self.db.displayStyle ~= "ALL" and "0" or "1")
...
--	SetCVar("nameplateMaxDistance", self.db.loadDistance)
	SetCVar("nameplateOtherTopInset", self.db.clampToScreen and "0.08" or "-1")
	SetCVar("nameplateOtherBottomInset", self.db.clampToScreen and "0.1" or "-1")
...
--	SetCVar("nameplateResourceOnTarget", 0)
	--讓堆疊血條的間距小一點
	SetCVar("nameplateOverlapH",  self.db.nameplateOverlapH or 0.3) --default is 0.8
	SetCVar("nameplateOverlapV",  self.db.nameplateOverlapV or 0.7) --default is 1.1
	SetCVar("nameplateLargeTopInset", .08)
	SetCVar("nameplateLargeBottomInset", .1)
	SetCVar("nameplateOccludedAlphaMult", 0.2)--障礙物後、視野外的名條透名度
	SetCVar("nameplateTargetBehindMaxDistance", 40)
--	SetCVar("nameplateMaxDistance", E.db.nameplates_v1.loadDistance or "4e1")

	--Player nameplate
--	SetCVar("nameplateShowSelf", (self.db.units.PLAYER.useStaticPosition == true or self.db.units.PLAYER.enable ~= true) and "0" or "1")
--	SetCVar("nameplatePersonalShowAlways", (self.db.units.PLAYER.visibility.showAlways == true and "1" or "0"))
--	SetCVar("nameplatePersonalShowInCombat", (self.db.units.PLAYER.visibility.showInCombat == true and "1" or "0"))
--	SetCVar("nameplatePersonalShowWithTarget", (self.db.units.PLAYER.visibility.showWithTarget == true and "1" or "0"))
--	SetCVar("nameplatePersonalHideDelaySeconds", self.db.units.PLAYER.visibility.hideDelay)
