...
local ItemProfConstants = CreateFrame( "Frame" )
...
local showProfs = true
local showQuests = true
local profFilter = 0xFF
local questFilter = 0x1FFFFF
local includeVendor = false
local iconSize = 16
...
function TT:LoadProfessionIcons()
	if not E.db.tooltip.professionicons then return end
